...
public interface IMultipleChoiceQuestionOptionRepository extends JpaRepository<QuestionOption, Long> {
    //   QuestionOption findByAnswerAndCorrectAnswerAndMultipleChoiceQuestion_QuestionAndMultipleChoiceQuestion_ScoreAndMultipleChoiceQuestion_QuestionNumberAndSubmittedQuestionOption(String answer, boolean correctAnswer,String question,double score, int questionNumber ,boolean submittedQuestionOption);
