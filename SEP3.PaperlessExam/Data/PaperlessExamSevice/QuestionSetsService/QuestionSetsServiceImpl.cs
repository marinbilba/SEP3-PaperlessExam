...
namespace SEP3.PaperlessExam.Data.PaperlessExamSevice.QuestionSetsService
{
    public class QuestionSetsServiceImpl : IQuestionSetsService
    {
        ...
        public async Task<QuestionsSet> FindTypeOfQuestion(string type)
        {
            // QuestionsSet setDeserialize = null;
            ...
            //     setDeserialize = JsonSerializer.Deserialize<QuestionsSet>(readAsStringAsync);
            //     if (type == "Written")
            //     {
            //        
            //     }
            ...
            QuestionsSet q1 = new WrittenSet("HAHA", "Mate", new User("hah", "yui"));
            return q1;
        }
    }
}